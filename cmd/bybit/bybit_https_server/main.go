...
import (
	...
	"github.com/bxcodec/go-clean-arch/internal/bybit_http_service"
...
func main() {
	...
	s := grpc.NewServer()
	grpcServer_Order := bybit_http_service.NewByBitHttpServerOrder(cfg)
	grpcServer_Position := bybit_http_service.NewByBitHttpServerPosition(cfg)
