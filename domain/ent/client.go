...
import (
	...
	"github.com/bxcodec/go-clean-arch/domain/ent/migrate"
...
// QueryWallets queries the wallets edge of a Account.
func (c *AccountClient) QueryWallets(a *Account) *WalletQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, account.WalletsTable, account.WalletsColumn),
		)
...
// UpdateOneID returns an update builder for the given id.
func (c *WalletClient) UpdateOneID(id int8) *WalletUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *WalletClient) DeleteOneID(id int8) *WalletDeleteOne {
...
func (c *WalletClient) Get(ctx context.Context, id int8) (*Wallet, error) {
	return c.Query().Where(wallet.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *WalletClient) GetX(ctx context.Context, id int8) *Wallet {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		Account, Wallet []ent.Hook
	}
	inters struct {
		Account, Wallet []ent.Interceptor
	}
)
