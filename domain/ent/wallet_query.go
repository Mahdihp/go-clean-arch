...
func (wq *WalletQuery) QueryAccount() *AccountQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, wallet.AccountTable, wallet.AccountColumn),
		)
...
func (wq *WalletQuery) FirstID(ctx context.Context) (id int8, err error) {
	var ids []int8
...
func (wq *WalletQuery) FirstIDX(ctx context.Context) int8 {
...
func (wq *WalletQuery) OnlyID(ctx context.Context) (id int8, err error) {
	var ids []int8
...
func (wq *WalletQuery) OnlyIDX(ctx context.Context) int8 {
...
func (wq *WalletQuery) IDs(ctx context.Context) (ids []int8, err error) {
...
func (wq *WalletQuery) IDsX(ctx context.Context) []int8 {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wq *WalletQuery) Clone() *WalletQuery {
	...
	return &WalletQuery{
		...
		withAccount: wq.withAccount.Clone(),
...
func (wq *WalletQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Wallet, error) {
	...
	if query := wq.withAccount; query != nil {
		if err := wq.loadAccount(ctx, query, nodes, nil,
			func(n *Wallet, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (wq *WalletQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Wallet, init func(*Wallet), assign func(*Wallet, *Account)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Wallet)
	for i := range nodes {
		if nodes[i].account_wallets == nil {
			continue
		}
		fk := *nodes[i].account_wallets
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "account_wallets" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (wq *WalletQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(wallet.Table, wallet.Columns, sqlgraph.NewFieldSpec(wallet.FieldID, field.TypeInt8))
	_spec.From = wq.sql
