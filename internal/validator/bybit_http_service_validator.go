...
func NewByBitValidator() ByBitValidator {
	return ByBitValidator{}
}

func (v ByBitValidator) ValidateCancel(req order.CancelOrderRequest) (map[string]string, error) {
...
func (v ByBitValidator) ValidateAmend(req order.AmendOrderRequest) (map[string]string, error) {
...
func (v ByBitValidator) ValidateCreate(req order.PlaceOrderRequest) (map[string]string, error) {
...
func (v ByBitValidator) ValidateTradingStop(req position.TradingStopRequest) (map[string]string, error) {
...
func (v ByBitValidator) ValidateSwitchMode(req position.SwitchModeRequest) (map[string]string, error) {
...
func (v ByBitValidator) ValidateSwitchIsolated(req position.SwitchIsolatedRequest) (map[string]string, error) {
...
func (v ByBitValidator) ValidateSetLeverage(req position.SetLeverageRequest) (map[string]string, error) {
...
func (v ByBitValidator) ValidateGetPositionInfo(req position.PositionInfoRequest) (map[string]string, error) {
